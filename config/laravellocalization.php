...
return [
    ...
    'supportedLocales' => [
        ...
        //'en-US-AU'       => ['name' => 'Australian English',     'script' => 'Latn', 'native' => 'Australian English', 'regional' => 'en_AU'],
        //'en-US-GB'       => ['name' => 'British English',        'script' => 'Latn', 'native' => 'British English', 'regional' => 'en_GB'],
        //'en-US-CA'       => ['name' => 'Canadian English',       'script' => 'Latn', 'native' => 'Canadian English', 'regional' => 'en_CA'],
        'en-US'       => ['name' => 'U.S. English',           'script' => 'Latn', 'native' => 'U.S. English', 'flag' => 'united-states.svg', 'regional' => 'en_US'],
        ...
        'pt-BR'       => ['name' => 'Brazilian Portuguese',   'script' => 'Latn', 'native' => 'português do Brasil', 'flag' => 'brazil.svg', 'regional' => 'pt-BR'],
    ...
    // For example, if `en-US` is default locale, then `/en-US/about` and `/about`
    // would be identical.
    //
    ...
    // For example, `/en-US/about` would be redirected to `/about`.
