            ...
            <div class="lg:ml-12 lg:mr-64">
                ...
                <div class="mt-12" x-data="{ isTrailerModalVisible: false }">
                    <button
                        ...
                        class="disabled:opacity-50 disabled:cursor-not-allowed disabled:bg-blue-500 flex bg-blue-500 text-white font-semibold px-4 py-4 hover:bg-blue-600 rounded transition ease-in-out duration-150"
