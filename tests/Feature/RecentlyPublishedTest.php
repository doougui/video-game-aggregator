...
use App\Http\Livewire\RecentlyPublished;
...
class RecentlyPublishedTest extends TestCase
{
    ...
    public function the_main_page_shows_recently_published_games()
    {
        ...
        Livewire::test(RecentlyPublished::class)
            ->assertSet('games', [])
            ->call('fetch')
    ...
    private function fakeRecentlyPublishedGames()
    {
        return Http::response([
          0 =>  [
            ...
            "first_release_date" => Carbon::now()->subMonths(1)->timestamp,
